...
<body>
    <!-- Navbar -->
    <header>
        <a href="#" class="logo">You Can Edit The Menu Here!</a>
        <div class="bx bx-menu" id="menu-icon"></div>

        <ul class="navbar">
            <li><a href="${pageContext.request.contextPath}/customers/addItems">Add Items</a></li>
            <li><a href="${pageContext.request.contextPath}/customers/UpdateItems">Update Items</a></li>
            <li><a href="${pageContext.request.contextPath}/customers/deleteItems">Delete Items</a></li>
