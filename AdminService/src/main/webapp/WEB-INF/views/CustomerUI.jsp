...
<body>
    ...
    <header>
        ...
        <ul class="navbar">
            <li><a href="${pageContext.request.contextPath}/customers/home3">Home</a></li>
            ...
            <li><a href="${pageContext.request.contextPath}/customers/service">Service</a></li>
            <li><a href="${pageContext.request.contextPath}/customers/contact">Contact</a></li>
       		<input type="text" placeholder="Search..">
            <!-- Dark Mode -->
                <li><a href="${pageContext.request.contextPath}/customers/logoutcust">Log Out</a></li>
        </ul>
    </header>
    <!-- Home  Section-->
